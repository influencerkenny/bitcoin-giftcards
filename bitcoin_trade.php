...
<head>
  ...
  <title>Buy/Sell Bitcoin | Bitcoin Giftcards</title>
...
<body>
  ...
  <main class="main-content" id="mainContent">
    <div class="container" style="max-width:600px;margin:48px auto 0 auto;background:#fff;border-radius:18px;box-shadow:0 4px 24px rgba(26,147,138,0.08);padding:32px 24px;text-align:center;">
      <h2><i class="bi bi-currency-bitcoin"></i> Buy/Sell Bitcoin</h2>
      <p>This page will allow you to buy or sell Bitcoin. Feature coming soon!</p>
    </div>
  </main>
  <!-- Footer -->
  <footer>
