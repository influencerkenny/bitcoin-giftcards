...
<head>
    ...
    <title>Admin Login | Bitcoin & Giftcard Trading Platform</title>
...
<body>
  <div class="login-container">
    ...
    <div class="glass-card">
      ...
      <div class="text">Admin Sign In</div>
      <div class="subtitle">Access the admin dashboard to manage trades and users.</div>
      <form method="post" action="admin_login.php" autocomplete="on" id="adminLoginForm">
  ...
  <div class="modal-bg" id="loginCongratsModal">
    <div class="modal-content">
      <h2>Welcome Admin!</h2>
      <p>Login successful.<br>Redirecting to admin dashboard...</p>
    </div>
  </div>
  <script>
      ...
      .then(data => {
        ...
        if (data.success) {
          ...
          if (!errorSpan) {
            ...
            adminLoginForm.appendChild(errorSpan);
          }
