...
<head>
  ...
  <title>Support | Bitcoin Giftcards</title>
...
<body>
  ...
  <nav class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li><a class="nav-link active" href="support.php"><span class="bi bi-life-preserver"></span> <span class="sidebar-label">Support</span></a></li>
  ...
  <main class="main-content" id="mainContent">
    <div class="container" style="max-width:600px;margin:48px auto 0 auto;background:#fff;border-radius:18px;box-shadow:0 4px 24px rgba(26,147,138,0.08);padding:32px 24px;text-align:center;">
      <h2><i class="bi bi-life-preserver"></i> Support</h2>
      <p>Support and help features will be available here soon.</p>
    </div>
  </main>
  <!-- Footer -->
  <footer>
