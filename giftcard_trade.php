...
<head>
  ...
  <title>Buy/Sell Giftcard | Bitcoin Giftcards</title>
...
<body>
  ...
  <nav class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li><a class="nav-link active" href="giftcard_trade.php"><span class="bi bi-gift"></span> <span class="sidebar-label">Buy/Sell Giftcard</span></a></li>
  ...
  <main class="main-content" id="mainContent">
    <div class="container" style="max-width:600px;margin:48px auto 0 auto;background:#fff;border-radius:18px;box-shadow:0 4px 24px rgba(26,147,138,0.08);padding:32px 24px;text-align:center;">
      ...
      <p>This page will allow you to buy or sell giftcards. Feature coming soon!</p>
    </div>
  </main>
  <!-- Footer -->
  <footer>
